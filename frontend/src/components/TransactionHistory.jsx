    ...
    const receiptContent = `
      ...
      <body>
        ...
        <div class="receipt-details">
          ...
          <p><strong>Number</strong> <span>${transaction.number}</span></p>
      ...
      <div className="mx-auto max-w-[607px] sm:max-w-[341px] md:max-w-[500px] min-[1500px]:max-w-[700px] xl:max-w-[1000px]">
        ...
        <div className="space-y-4 mb-8">
          <input
            ...
            className="w-full px-2 py-1 text-primary dark:text-white bg-white dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="flex flex-wrap gap-4">
            <select
              name="category"
              id="category"
              className="custom-select flex-grow px-2 py-1 text-primary dark:text-white bg-white dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="flex gap-4">
            <input
              type="date"
              className="flex-grow px-2 py-1 text-primary dark:text-white bg-white dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
        ...
        <div className="bg-white dark:bg-gray-800 relative rounded-xl shadow-lg overflow-hidden">
