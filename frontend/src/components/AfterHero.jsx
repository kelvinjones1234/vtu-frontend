  ...
  ({ feature, index, animationVariants, transition }) => {
    return (
      ...
      >
        ...
        <h3 className="text-[1rem] uppercase pb-4 font-heading_two font-bold text-indigo-700 dark:text-indigo-400">
          {feature.title}
        </h3>
        <p className="max-w-[450px] mx-auto text-gray-700 dark:text-gray-200">
          {feature.description}
...
const AfterHero = () => {
  ...
  return (
    <div className="px-[1rem] ss:px-[6rem] mt-[15vh] font-body_two">
      <div className="image flex justify-center">
        <motion.h1
          className="text-indigo-700 dark:text-indigo-400 py-4 sm:pb-8 text-[1.5rem] font-bold font-heading_two"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
      ...
      >
        <div className="text mx-4">
          <h3 className="text-indigo-700 dark:text-indigo-400 font-heading_two py-4 text-[1.2rem] font-bold">
            Have Questions?
          </h3>
          <p className="max-w-[450px] mx-auto text-gray-700 dark:text-gray-200">
            Reach out to our customer service assistant for complaints and
        ...
        <div className="register p-3 mt-4">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="transition text-white bg-blue-600 hover:bg-blue-500 rounded-2xl py-[.46rem] duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg mx-4 px-6 font-medium"
          >
            Contact Us
          </motion.button>
        </div>
