...
//                   </span>
//                 </h1>
//                 <p className="text-lg text-gray-700 dark:text-gray-200 inline-block pb-3">
//                   Powering Your Connections
//                 </p>
//               </div>

//               <motion.div
//                 className="buttons flex sm:justify-start justify-center mb-[8vh] mt-[8vh] font-body_two"
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
...
//                   >
//                     <motion.button
//                       className="bg-blue-500 py-[.4rem] mr-9 px-6 text-[.9rem] sm:text-[1.2rem] md:text-[1.5rem] bg-opacity-[90%] transition duration-300 ease-in-out transform hover:-translate-y-1 text-white rounded-2xl font-bold"
//                       whileHover={{ scale: 1.05 }}
//                       whileTap={{ scale: 0.95 }}
//                     >
//                       Register
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              >
                ...
                <div className="register">
                  ...
                  >
                    <motion.button
                      className="bg-blue-600 py-[.4rem] mr-9 px-6 text-[.9rem] sm:text-[1.2rem] md:text-[1.5rem] bg-opacity-[90%] transition duration-300 ease-in-out transform hover:-translate-y-1 text-white rounded-2xl font-bold"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      Register
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.4 }}
            >
              <h3 className="text-[1rem] md:text-[1.5rem] uppercase py-4 font-heading_two font-bold text-indigo-700 dark:text-indigo-400">
                Instantly Top Up Anytime, Anywhere...
              </h3>
              <p className="font-body_two text-gray-700 dark:text-gray-200 pb-[3vh] md:text-[1.1rem]">
                At MaduConnect, we understand the importance of staying
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-indigo-800/30">
                <div className="flex items-center gap-2 my-2">
                  <div className="w-2 h-2 rounded-full bg-indigo-700 dark:bg-indigo-400"></div>
                  <p className="text-sm text-gray-700 dark:text-gray-200">
                    Secure transactions
                  </p>
                </div>
