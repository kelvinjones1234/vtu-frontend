          ...
          <div className="lg:col-span-1">
            ...
            >
              <div className="font-bold mb-[4vh] font-heading_two">
                <h1 className="text-3xl xs:text-[3rem] sm:text-5xl md:text-[4rem] xl:text-[5rem] lg:text-[4rem] font-extrabold text-sky-400 dark:text-gray-800  mb-6 font-heading_two leading-tight">
                  Welcome to{" "}
